...
import com.msd.ledgerservice.filter.RequestHeaderFilter;
import com.msd.ledgerservice.security.RestAuthenticationEntryPoint;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf().disable()
                .authorizeRequests().antMatchers("/auth/login","/swagger-ui.html",
